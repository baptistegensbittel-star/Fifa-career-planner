    ...
    <div className="sticky top-0 z-40 border-b border-white/10 bg-[#0d1220]">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-4 py-3">
        ...
        <select
          ...
          className="rounded border border-white/10 bg-black/20 px-2 py-1 text-[28px] text-white outline-none focus:border-[#5b8cff]/60"
        >
        ...
        {editingSeason ? (
          <input
            ...
            className="w-24 rounded border border-white/10 bg-black/20 px-2 py-1 text-[28px] text-white outline-none focus:border-[#5b8cff]/60"
          />
        ) : (
          <button
            type="button"
            onClick={() => setEditingSeason(true)}
            className="rounded border border-white/10 px-2 py-1 text-[28px] text-gray-400 hover:bg-white/5"
        ...
        <nav className="ml-auto flex items-center gap-4">
          {tabs.map((t) => (
            <button
              ...
              className={`border-b-2 pb-0.5 text-3xl transition-colors ${
                tab === t.id
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="rounded border border-white/10 px-2 py-1.5 text-[28px] text-gray-300 hover:bg-white/5"
